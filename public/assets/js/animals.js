...
const getAnimals = (formData = {}) => {
  ...
  // when the above is done, we send our array of animal data to the printResults() function
  // it then generates cards for each animal and prints them to the page
  .then(animalData => {
